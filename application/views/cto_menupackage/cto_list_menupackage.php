        ...
        <section class="col-lg-10 connectedSortable">
          ...
          <div class="box box-solid">
            <div class="box-header">
              ...
              <h4 class="box-title">List of Menu Package</h4>
              <!-- tools box -->
 ...
 $(document).ready(function(){
  ...
  function fetch_data(){
   ...
   var dataTable = $('#example1').DataTable({
    ...
    "order" : [],
    "ajax" : {
     url:"<?php echo base_url(); ?>cto_menupackage/fetch",
     type:"POST"
    }
   });
   cto_loading_hide();
  ...
  $(document).on('click', '.delete', function(){
   ...
   {
    $.ajax({
     url:"<?php echo base_url(); ?>cto_menupackage/delete",
     method:"POST",
     data:{id:id},
  ...
  $(document).on('click', '.undelete', function(){
   ...
   {
    $.ajax({
     url:"<?php echo base_url(); ?>cto_menupackage/undelete",
     method:"POST",
     data:{id:id},
     success:function(data){
		 data = $.parseJSON(data);
