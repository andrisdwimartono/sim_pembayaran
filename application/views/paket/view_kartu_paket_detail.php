        ...
        <section class="col-lg-10 connectedSortable">
          ...
          <div class="box box-solid">
            <div class="box-header">
              ...
              <h4 class="box-title">Lihat Kartu Paket Pembayaran</h4>
              <!-- tools box -->
			...
			<div class="form-group" id="ctof_termin_paket">
				<div class="col-sm-2">
					<b>Jumlah Termin</b>
				</div>
				<div class="col-sm-5">
			...
			<div class="form-group" id="ctof_termin_paket">
				...
				<div class="col-sm-5">
					: <?php if($aktif ==  1){echo "Aktif";}else{echo "Tidak Aktif";} ?>
				</div>
			</div>
			</form>
              ...
              <table class="table table-striped">
                <tr>
                  ...
                  <th>Nominal</th>
                    ...
                    $i = 1;
                    $tot = 0;
                    foreach($paket_detail as $pak_det){
                        echo "<tr><td>".$i++."</td>";
                        echo "<td>".number_format($pak_det->nominal, 2)."</td></tr>";
                        $tot += $pak_det->nominal;
                    }
                    ?>
                <tf>
